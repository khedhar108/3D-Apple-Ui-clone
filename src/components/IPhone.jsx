...
*/
//! scene.glb ---drop this file here ---> https://gltf.pmnd.rs/   ---and copy the code 
...
function Model(props) {
  ...
  //****-----changing Iphone cover color -backside - with given list------------
  const texture = useTexture(props.item.img);
    ...
    useEffect(() => {
      Object.entries(materials).map((material) => {
        ...
        if (
          // ! these Materials name are hardCoded only here randomly  or we have to match exact same but don't know frowm where they are coming
